...
| `gameSessionSchemaVersion`            | `bigint?`                                            | Rust-owned schema ID for `serializedGameSession`; currently `21`. Missing or mismatched IDs are unsupported and cleared before deserialization.                                                                                                                                                                 |
