...
import { CreateNewCatWalletRequest, CreateNewCatWalletResponse } from '../types/rpc/CreateNewCatWallet';
import { CreateNewDidWalletRequest, CreateNewDidWalletResponse } from '../types/rpc/CreateNewDidWallet';
import { CreateOfferForIdsRequest, CreateOfferForIdsResponse } from '../types/rpc/CreateOfferForIds';
import { GetAllOffersRequest, GetAllOffersResponse } from '../types/rpc/GetAllOffers';
import { GetCatAssetIdRequest, GetCatAssetIdResponse } from '../types/rpc/GetCatAssetId';
import { GetCatWalletInfoRequest, GetCatWalletInfoResponse } from '../types/rpc/GetCatWalletInfo';
...
import { SignMessageByAddressRequest, SignMessageByAddressResponse } from '../types/rpc/SignMessageByAddress';
import { SignMessageByIdRequest, SignMessageByIdResponse } from '../types/rpc/SignMessageById';
...
interface _JsonRpc {
  ...
  getWalletAddresses: (data: GetWalletAddressesRequest) => Promise<GetWalletAddressesResponse>;
  ...
  // CATs
  createNewCatWallet: (data: CreateNewCatWalletRequest) => Promise<CreateNewCatWalletResponse>;
...
async function getCurrentAddress(data: GetCurrentAddressRequest) {
  return await request<GetCurrentAddressResponse>(ChiaMethod.GetCurrentAddress, data);
}
...
async function signMessageById(data: SignMessageByIdRequest) {
  return await request<SignMessageByIdResponse>(ChiaMethod.SignMessageById, data);
}

async function signMessageByAddress(data: SignMessageByAddressRequest) {
  return await request<SignMessageByAddressResponse>(ChiaMethod.SignMessageByAddress, data);
}

async function verifySignature(data: VerifySignatureRequest) {
  return await request<VerifySignatureResponse>(ChiaMethod.VerifySignature, data);
}
...
async function getWalletAddresses(data: GetWalletAddressesRequest) {
  return await request<GetWalletAddressesResponse>(ChiaMethod.GetWalletAddresses, data);
}
...
async function checkOfferValidity(data: CheckOfferValidityRequest) {
  return await request<CheckOfferValidityResponse>(ChiaMethod.CheckOfferValidity, data);
}
...
async function getOfferSummary(data: GetOfferSummaryRequest) {
  return await request<GetOfferSummaryResponse>(ChiaMethod.GetOfferSummary, data);
}
...
async function createNewCatWallet(data: CreateNewCatWalletRequest) {
  return await request<CreateNewCatWalletResponse>(ChiaMethod.CreateNewCatWallet, data);
}

async function getCatWalletInfo(data: GetCatWalletInfoRequest) {
  return await request<GetCatWalletInfoResponse>(ChiaMethod.GetCatWalletInfo, data);
}
...
async function createNewDidWallet(data: CreateNewDidWalletRequest) {
  return await request<CreateNewDidWalletResponse>(ChiaMethod.CreateNewDidWallet, data);
}
...
async function getNftWalletsWithDids(data: GetNftWalletsWithDidsRequest) {
  return await request<GetNftWalletsWithDidsResponse>(ChiaMethod.GetNftWalletsWithDids, data);
}
