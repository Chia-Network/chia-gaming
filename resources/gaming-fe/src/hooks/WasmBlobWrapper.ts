...
async function anempty(id: number) {
  return { EMPTY: id };
}
...
export function getNewChiaGameCradle(
  ...
  console.log(
    `constructed cradle ${params.iStarted} with id ${cradleId} and publicKey ${params.chiaIdentity.public_key}`,
  );
...
export class WasmBlobWrapper {
    ...
    return this.blockchain
      ...
      .then((result) => {
        ...
        if (typeof coin !== "string") {
          ...
          const new_coin_string =
            this.wasmConnection.convert_coinset_to_coin_string(
  ...
  blockNotification(
    peak: number,
    blocks: JsCoinSetSpend[] | undefined,
    block_report: any,
  ) {
