...
pub fn serialize_referee<S: Serializer>(x: &Rc<dyn RefereeInterface>, s: S) -> Result<S::Ok, S::Error>
{
    x.get_serialized_form().serialize(s)
}

pub fn serialize_referee_option<S: Serializer>(x: &Option<Rc<dyn RefereeInterface>>, s: S) -> Result<S::Ok, S::Error>
{
...
pub fn deserialize_referee_option<'de, D>(deserializer: D) -> Result<Option<Rc<dyn RefereeInterface>>, D::Error>
where
    D: Deserializer<'de>
{
...
pub struct RewindResult {
    ...
    #[serde(serialize_with = "serialize_referee_option", deserialize_with = "deserialize_referee_option")]
