...
impl TheirTurnReferee {
    ...
    pub fn run_validator_for_move(
        ...
        //     );
        // }
        let (_state, validation_program) = self.get_validation_program_for_move()?;
    ...
    fn make_slash_for_their_turn(
        ...
        let (state, validation_program) = self.get_validation_program_for_move()?;
    ...
    pub fn check_their_turn_for_slash(
        ...
        let full_slash_result = self.run_validator_for_move(allocator, evidence)?;
