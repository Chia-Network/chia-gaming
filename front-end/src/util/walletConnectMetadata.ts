...
// renderer runs under its own scheme (`chiagaming://app`), which wallets cannot
// open or fetch, so any non-http(s) origin falls back to a stable https
// identity (repo homepage + raw logo URL).
